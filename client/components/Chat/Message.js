...
function Message(props) {
  ...
  if(message._sender === user._id) {
    ...
    <li className="thread-item">
      ...
      <span className="gc-message-thumbnail--me" style={{ backgroundImage: `url(${user.profilePhoto || '/images/default-profile.png'})`, backgroundSize: 'cover' }} />
    </li>
    );
  } else {
    return (
      <li className="thread-item clearfix">
        <span className="gc-message-thumbnail" style={{ backgroundImage: `url(${ chef.profilePhoto })`, backgroundSize: 'cover' }} />
