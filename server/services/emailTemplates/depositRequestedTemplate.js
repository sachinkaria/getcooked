...
<section style="max-width:600px;margin:auto;padding:20px;border-bottom: 1px solid #ffc9ba;border-top: 1px solid #ffc9ba; font-family:Verdana, Geneva, sans-serif; font-size:14px;color: #5e5e5e; text-align: center;" >
    <article>
        <p style="font-size: 20px; color: #5e5e5e;">${_.startCase(_.toLower(user.displayName))} has requested a deposit payment to confirm your event. Click below to confirm and pay.</p>
<a style="text-decoration: none;" href="${hostname}">
<button style="display:block;margin:auto; text-align: center; padding:20px ;width:200px; border-radius: 4px; height: 36px;font-size: 16px; padding: 0; background-color: #f05125; color:white; margin: auto; ">Confirm and Pay</button>
<a/>
</span>
</div>
    </article>
