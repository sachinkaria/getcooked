            ...
            <Row className="gc-center">
              <Col>
                <Link to={`/chefs/${this.props.booking.chef._id}`}>
                  <img alt={this.props.booking.chef.displayName} src={this.props.booking.chef.profilePhoto} className="gc-thumbnail gc-margin-bottom--xs" />
      ...
      <Col xs={12}>
        <Panel>
          <Row>
            <Col md={6}>
              <div>
                <p className="gc-form-heading text-capitalize">{this.props.booking.user.firstName} {this.props.booking.user.lastName}</p>
                <p className="gc-text"><span className="gc-bold">Mobile number:</span> +44 {this.props.booking.user.mobileNumber}</p>
