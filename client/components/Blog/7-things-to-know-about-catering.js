...
function BookingACaterer() {
  return (
    <section className="gc-section">
      <Helmet>
        <meta charSet="utf-8" />
        <title>7 Things to Consider When Booking a Caterer | Get Cooked</title>
        ...
        <meta property="og:image" alt="7 things to consider when booking a caterer" content="https://www.getcooked.co/images/catering-3.jpg" />
          ...
          <Row>
            ...
            <Col xs={12}>
              <p className="gc-text gc-text--lg">
                When planning an event, you need a plan of attack to choose and book a caterer - especially
