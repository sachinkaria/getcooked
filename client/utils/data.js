const data = [
  {
    ...
    name: 'Sachin Karia',
    badges: [
      { name: 'vegan', logo: 'images/vegan.svg' },
  ...
  },
  {
    ...
    badges: [
      { name: 'vegan', logo: 'images/vegan.svg' },
      { name: 'barbecue', logo: 'images/barbecue.svg' },
      { name: 'cake', logo: 'images/cake.svg' }
    ],
  ...
  },
  {
    ...
    name: 'Another Truck',
    badges: [
      { name: 'cocktail', logo: 'images/cocktail.svg' },
      { name: 'chef', logo: 'images/chef.svg' },
      { name: 'barbecue', logo: 'images/barbecue.svg' },
      { name: 'vegan', logo: 'images/vegan.svg' }
...
export const CUISINES = ['american', 'african', 'chinese', 'caribbean', 'french', 'greek', 'indian', 'italian', 'japanese', 'mediterranean', 'mexican', 'moroccan', 'spanish', 'thai', 'turkish', 'vietnamese', 'other'];
