  ...
  render() {
    ...
    return (
      <div>
        {
          this.props.mobile ?
            <Button disabled block className="gc-btn gc-btn--sticky gc-btn--orange visible-xs" onClick={this.showModal}>
              Book now
            </Button>
            :
            <Button disabled block className="gc-btn gc-btn--orange" onClick={this.showModal}>
              Book now
            </Button>
        }
        <Modal
