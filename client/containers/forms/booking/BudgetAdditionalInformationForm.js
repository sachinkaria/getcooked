    ...
    return (
      <div>
        <form onSubmit={handleSubmit(this.handleFormSubmit)}>
          <div>
            <label className="gc-text">Approximately many guests are you expecting?</label>
            ...
            <label className="gc-text">What is estimated budget for the entire event? (incl. staff, equipment & food)</label>
            <div className="gc-margin-bottom">
              <Field
                addonText="£"
                withAddon
            ...
            <label className="gc-text">Do you have any additional information that you would like to provide us with?</label>
            <div className="gc-margin-bottom">
              <Field
